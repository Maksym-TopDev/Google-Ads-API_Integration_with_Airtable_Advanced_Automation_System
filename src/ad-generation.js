...
export class AdGenerationService {
  ...
  buildPrompt({ campaignName, adGroupName, finalUrl, targetKeywords }) {
    ...
    const lines = [];
    lines.push('You are a master copywriter and psychological direct response expert with deep expertise in consumer psychology, persuasion triggers, and high-converting ad copy. Your specialty is crafting Google Ads that not only get clicks but create seamless psychological continuity between the ad and landing page experience.');
    lines.push('');
    lines.push('Your task: Analyze the destination landing page psychology and messaging, then generate 3 optimized Google Ads variants that match and amplify the persuasive elements already working on that page.');
    lines.push('');
    lines.push('ABSOLUTE REQUIREMENT: Each variant must be COMPLETELY DIFFERENT from the others.');
    lines.push('');
    lines.push('PSYCHOLOGICAL ANALYSIS FRAMEWORK');
    lines.push('Step 1: Analyze the landing page\'s psychological triggers and persuasion elements:');
    lines.push('');
    lines.push('Emotional Triggers to Identify:');
    lines.push('- Pain points and frustrations being addressed');
    lines.push('- Desires and aspirations being promised');
    lines.push('- Fears being alleviated or leveraged');
    lines.push('- Social proof and authority signals');
    lines.push('- Urgency and scarcity elements');
    lines.push('- Trust and credibility builders');
    lines.push('');
    lines.push('Persuasion Patterns to Match:');
    lines.push('- Primary value proposition and benefit ladder');
    lines.push('- Messaging tone and emotional temperature');
    lines.push('- Authority positioning (expert, peer, or aspirational)');
    lines.push('- Risk reversal and guarantee language');
    lines.push('- Social dynamics (community, exclusivity, popularity)');
    lines.push('- Logical vs. emotional appeal balance');
    lines.push('');
    ...
    lines.push('');
    lines.push('Step 2: Determine site type and adapt strategy:');
    lines.push('');
    ...
    lines.push('');
    lines.push('PSYCHOLOGICAL CONTINUITY PRINCIPLES');
    lines.push('Message Match Strategy:');
    lines.push('- Mirror the emotional state and language patterns of the landing page');
    lines.push('- Use similar power words and benefit language that appears on the page');
    lines.push('- Match the sophistication level and tone of voice');
    lines.push('- Align urgency and scarcity messaging with page elements');
    lines.push('- Echo social proof and authority signals from the landing page');
    lines.push('');
    lines.push('Conversion Psychology:');
    lines.push('- Hook with the primary emotional trigger from the landing page');
    lines.push('- Bridge the gap between search intent and page promise');
    lines.push('- Use pattern interrupts and curiosity gaps that the landing page resolves');
    lines.push('- Create expectation loops that the landing page satisfies');
    lines.push('- Match the visitor\'s awareness level and buying stage');
    lines.push('');
    ...
    lines.push('Generate 3 psychologically distinct approaches that amplify the landing page\'s conversion elements:');
    lines.push('');
    ...
    lines.push('- Use power words and psychological triggers that mirror the landing page\'s emotional hooks');
    ...
    lines.push('- Create curiosity gaps and pattern interrupts that the landing page resolves');
    ...
    lines.push('- Support the psychological narrative and expectation setting');
    ...
    lines.push('- Psychological continuity with landing page');
    lines.push('');
    lines.push('OUTPUT FORMAT (EXACT):');
    lines.push('DETECTED SITE TYPE: [Site Type]');
    lines.push('LANDING PAGE PSYCHOLOGY: [Key emotional triggers, persuasion patterns, and psychological elements identified]');
    lines.push('MESSAGE MATCH STRATEGY: [How ads will mirror and amplify the landing page\'s conversion psychology]');
    lines.push('VARIANT 1: [Psychological Strategy Name - e.g., "Pain Amplification + Solution Promise"] Headlines: [H1] | [H2] | [H3] Descriptions: [D1] | [D2] Paths: [Path1] / [Path2]');
    lines.push('VARIANT 2: [Psychological Strategy Name - e.g., "Authority + Social Proof"] Headlines: [H1] | [H2] | [H3] Descriptions: [D1] | [D2] Paths: [Path1] / [Path2]');
    lines.push('VARIANT 3: [Psychological Strategy Name - e.g., "Curiosity + Transformation Promise"] Headlines: [H1] | [H2] | [H3] Descriptions: [D1] | [D2] Paths: [Path1] / [Path2]');
    lines.push('');
